...
func TestAddTask(t *testing.T) {
	...
	check := func() {
		for _, v := range tbl {
			...
			// Очень странное условие при наличии кейса {"today", "Фитнес", "", "d 1"}, как дата должна быть сегодня, если у нас сегодня + 1 от условия
			// На этом кейсы тест валится, обратите внимание, возможно я что-то недопонял
